...
class APIApi(object):
    ...
    def get_api_version(self, **kwargs):  # noqa: E501
        ...
        Returns information about the service API. This service is public API since Teamscale 5.8. The API requires no login  # noqa: E501
    ...
    def get_api_version_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(ServiceApiInfo, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            response_type='ServiceApiInfo',  # noqa: E501
