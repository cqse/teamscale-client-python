...
class BodyPart(object):
    ...
    def __init__(self, content_disposition=None, entity=None, headers=None, media_type=None, message_body_workers=None, parent=None, providers=None, local_vars_configuration=None):  # noqa: E501
